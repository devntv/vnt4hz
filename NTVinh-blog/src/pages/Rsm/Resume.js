import { Grid, Typography, Avatar, Icon, Paper } from "@material-ui/core";
...
import { ContentSkeleton } from "../../components/loadingSkeleton/ContentSkeleton";
            ...
            <>
                ...
                <Grid container className="Sec pb_40">
                    <Grid item className="Sec-Tlt mb_20">
                        ...
                        <h4 className="Sec-Tlt_text">About me</h4>  
                           <svg xmlns="http://www.w3.org/2000/svg"  width='82' height='8' viewBox='0 0 80 8' fill='none' className="svgEffect">
                            <path d='M1.36658 3.43961C5.25984 2.21819 9.10198 2.35113 13.042 1.74498C16.5973 1.19801 20.2829 1.33594 23.9226 1.33594C27.3725 1.33594 30.9056 1.5463 34.2891 1.5463C35.5441 1.5463 37.2693 2.05276 38.3912 2.55139C39.6341 3.10379 41.4642 3.25919 42.8089 3.4513C44.602 3.70745 46.3029 3.86034 48.1616 3.86034C49.0606 3.86034 49.9761 3.43961 50.9081 3.43961C51.4475 3.43961 52.841 3.17686 53.3273 2.97213C55.1318 2.21235 56.3597 3.3818 57.5346 4.49145C58.2657 5.18187 59.2379 3.46932 60.0123 3.18249C60.9779 2.82484 61.679 2.53519 62.4783 3.33443C62.7994 3.65557 63.8588 5.51258 64.3716 5.22773C65.485 4.60917 66.7235 4.15447 67.7258 3.33443C69.0587 2.24383 71.3278 2.48068 73 2.38777C74.4626 2.30652 75.525 2.05998 77 2.38777C77.7415 2.55256 78.7556 2.38777 79.518 2.38777C80.2804 2.38777 81.1728 1.74498 82 1.74498'
                                  strokeWidth='2' strokeLinecap='round' strokeLinejoin='2' stroke='hsl(222deg, 100%, 60%)'
                            ></path>
                        </svg>   
                    </Grid>
                    <Grid item xs={12}>
                        <Typography variant="body3" className="content_about-me">
                            {" "}
                            {DataPft.about}
                        </Typography>
                ...
                <Grid container className="Sec pb_40">
                    ...
                    <Grid item className="Sec-Tlt mb_20 ">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"  width='84' height='8' viewBox='0 0 83 7' fill='none' className='svgEffect'>
                    ...
                    <Grid item xs={12} className="Step-skill">
                        <Grid container className="project_timeL">
                            <Grid item sm={12} md={6}>
                                <TimeL className="Step-skill" title="Respositories" icon={<CodeIcon />}>
                                        ...
                                        <TimelineItem key={key}>
                                            ...
                                            <TimelineContent>
                                                ...
                                                <Typography className="timeline-date" variant="caption">
                                                 {project.date ? 
                                                        <> <BsArrowUp className= "timeline-date_timer__iconArrowTop" />created: {project.dateCreate} ago  · <ImEarth className="timeline-date_timer__iconEarth"/></>
                                                               :''} {project.date}        
                                                ...
                                                <Typography className="timeline-desc" variant="body2">
                                                  ...
                                                  {project.descfunction ? `project used with main technology: ${project.desc}`:'Other project available at my github.'}  
                                                </Typography>
                                                ...
                                                {loadingBtn ? (
                                                    ...
                                                    <>
                                                        <BtnLike
                                                            ...
                                                            onSound={true}
                                                        /> 
                                                        <Typography onClick={handleSetDeveloping} className="timeLine_developing" component='span' variant ='overline'>
                                                           {project.develop ? <> <RiSettings4Fill className="timeLine_developing-icon" onAnimationEnd ={handleSetDeveloping}/>{developing ? '':'developing...'} </>:'' }
                                                        </Typography>
                                                    </>    
                                                    )  }
                                                    {project.linkgit ? <GithubLink link={project.linkgit}/> : ''}                                           
                                            </TimelineContent>
                                        </TimelineItem>
                                    ))}
                                </TimeL>
                                    ...
                                    {DataPft.techs.map((project, key) => (
                                        <TimelineItem key={key}>
                                            ...
                                            <TimelineContent>
                                                ...
                                                <Typography component='div' className="FrameWork">
                                                    <Avatar
                                                        src={project.avatar}
                                                        ariant="rounded"
                                                        alt="avatar of NTV"
                                                    ...
                                                    {project.avatarFrameWork ? <><Avatar
                ...
                <Grid container className="Sec pb_40">
                    <Grid item className="Sec-Tlt mb_20 ">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"  width='94' height='9' viewBox='0 0 80 8' fill='none' className="svgEffect">
                            ...
                            {DataPft.MyHobbies.map((hobbie, key) => (
                                <Grid item xs={12} sm={6} md={3} key={key}>
                                    <div className="service">
                                        ...
                                        <Typography className="service_title" variant='h6'>{hobbie.title}</Typography>
                                        <Typography className="service_desc" variant='body2'>{hobbie.desc}</Typography>
                                        {
                                            hobbie.stress ? <Typography className={hobbie.maxstress ? 'service_maxstress' : 'service_mildstress'} variant="button">{ hobbie.stress }</Typography> : ''
                                        }
                ...
                <Grid container spacing={3} className="Sec pb_40 p_50">
                    <Grid item xs={12}>
                        <h4 className="skill_tlt"><BsHash className="skill_tlt_hash" />Skills</h4>
                                ...
                                <Grid item xs={12} sm={6} md={3} key={key}>
                                    <Paper elevation={0} className="skill">
                                        ...
                                        {skill.desc.map((item, key) => (
                                            <Typography variant="body2" className="skill_desc" key={key}>
