        ...
        <>
            <div className="p-f  container_shadow">
                ...
                highlightColor={theme ==='dark'? "#2c2d2d" :"#d8dcdc"}>
                    <Skeleton duration={2} className="loadingcontentProfile" circle={true} height={216} width={216} />
                    <p></p>
                    <Skeleton className="loadingcontentProfile" count={1} height={40} width={200} />
                    <p></p>
                    ...
                    <p></p>
                    <Skeleton className="loadingcontentProfile" count={1} height={30} width={250} />
                    <p></p>
                </SkeletonTheme>
            </div>
        </>
